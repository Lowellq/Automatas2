...
class comp implements compConstants {
        ...
        public static void main( String[] args )throws ParseException, Exception
        {
                try
                {
                comp analizador = new comp(new FileInputStream("C:/Users/Lowell/eclipse-workspace/Proyectos/src/CompiladorSematicoFinal/code.txt"));
                        analizador.Programa();
                        System.out.println();
                        System.out.println();
                        TokenAsignaciones.TablaSimbolos();
