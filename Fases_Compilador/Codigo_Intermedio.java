...
public class Codigo_Intermedio {
	...
	static Codigo_Intermedio_Objeto DatosNivel1[] = new Codigo_Intermedio_Objeto[20];
	static String[] FuncionDivEstado;
	static Codigo_Intermedio_Variable_Valor ValorVariable[] = new Codigo_Intermedio_Variable_Valor[10];
	
	public static void Inicio(TablaSimbolos[] Datos, int ContadorGlobal) 
	{
		System.out.println();
		System.out.println();
		System.out.println("");
		...
		System.out.println();
		System.out.print("Escribe una Expresion en infijo: ");//A * N9 + ( C - D / A ) / N1
		...
		ImpresionTriplos();
		System.out.println();
		//ImpresionEstado(FuncionDivEstado);
...
// A + B - ( C - D / A ) * F
	...
	private static void ProcesoTriplos(String[] FuncionDiv, Codigo_Intermedio_Objeto[] DatosNivel1 ) 
	{
...
//						double Resultado=0;
	...
	public static void Inicializacion()
	{
		...
		{
			ValorVariable[b] = new Codigo_Intermedio_Variable_Valor("0", 0);
		}
	}
	...
	public static void InicializacionTriplos()
	{
			...
			DatosNivel1[0] = new Codigo_Intermedio_Objeto ("Arg1","0","0","0", 0);
			DatosNivel1[1] = new Codigo_Intermedio_Objeto ("Arg2","0","0","0", 0);
			DatosNivel1[2] = new Codigo_Intermedio_Objeto ("Arg3","0","0","0", 0);
			DatosNivel1[3] = new Codigo_Intermedio_Objeto ("Arg4","0","0","0", 0);
			DatosNivel1[4] = new Codigo_Intermedio_Objeto ("Arg5","0","0","0", 0);
			DatosNivel1[5] = new Codigo_Intermedio_Objeto ("Arg6","0","0","0", 0);
			DatosNivel1[6] = new Codigo_Intermedio_Objeto ("Arg7","0","0","0", 0);
			DatosNivel1[7] = new Codigo_Intermedio_Objeto ("Arg8","0","0","0", 0);
			DatosNivel1[8] = new Codigo_Intermedio_Objeto ("Arg9","0","0","0", 0);
			DatosNivel1[9] = new Codigo_Intermedio_Objeto ("Arg0","0","0","0", 0);
	...
	private static void InsercionVariablesValores(String[] FuncionDiv, TablaSimbolos[] Datos, int ContadorDatos) {
		String Valor;
		boolean A;
		for(int x=0; x < FuncionDiv.length; x++)
		{	
	...
	{	System.out.println("------------->     Triplos           ");
		...
		for(int x=0; x < 10; x++)
		{
			...
			if(notEqual == true)
			{
			System.out.println("   "+DatosNivel1[x].getIdentificador()+"\t\t "+DatosNivel1[x].getValor1()+"\t\t"+DatosNivel1[x].getOperacion()+"\t\t"+DatosNivel1[x].getValor2()+"\t\t"+DatosNivel1[x].getResultado());
			}
		}
