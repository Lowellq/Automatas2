...
import java.io.*;
import Fases_Compilador.ParseException;
...
class Compilador implements CompiladorConstants {
  ...
  static final public void VariablesLocales() throws ParseException {
    ...
    var = jj_consume_token(IDENTIFIER);
    	FaseSemantica.InsertarSimbolo(var, td);
  ...
  static final public void VariablesAsignacion(Token v1, int Tipo) throws ParseException {
    ...
    TiposAsignaciones();
                v2 = token;
                res = FaseSemantica.checkAsing(v1, v2, Tipo);
    ...
    while (true) {
      ...
      TiposAsignaciones();
                v3 = token;
                res = FaseSemantica.checkAsing(v1, v3, tipo);
  ...
  static final public void SentenciaAsignacion() throws ParseException {
    ...
    case DECR:
      ...
      default:
        ...
        res = FaseSemantica.checkVariable(v1);
